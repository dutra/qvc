...
def concat_light_curves(filter_object_ids=None, progress_bar=False, skip=None, N=None):
    ...
    cat = pd.read_parquet("data/S82/Catalog.parquet").set_index("idx")
    sdss = pd.read_parquet("data/S82/dr16s82_sdssLCRaw.parquet")
    sdss = sdss[sdss.mjd.notna()].copy()

    ps1 = pd.read_parquet("data/S82/dr16s82_ps1LCRaw.parquet")
    ztf = pd.read_parquet("data/S82/dr16s82_ZuberLCRaw.parquet")
