...
multi_object_ids = [
    1458203, 1460028, #referee
    1410570,
    #1414639, # bad fit?
    # definitely bal
    #1410570, 1422228, 1400339, 1425653,
...
if mode == "single":
    ...
    run_tag = f"aug31b_nobal_{object_id}_notebook_sdss_spectrum"
    nproc = 1
elif mode == "parallel":
