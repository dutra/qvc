...
copy_hubble_assets() {
  ...
  copy_from_dir "$FIDUCIAL_DIR" "diagnostics/bpl_psd_vs_uv_variability_precut.pdf" "hubble" "bpl_psd_vs_uv_variability_precut.pdf"
  ...
  copy_from_dir "$FIDUCIAL_DIR" "$FIDUCIAL_RUN_DIR/completeness/completeness_map_with_relative_percent_contours.pdf" "hubble" "completeness_map.pdf"
  copy_from_dir "$FIDUCIAL_DIR" "diagnostics/tier1_cuts_vs_redshift_precut.pdf" "hubble" "spectral_fraction_vs_redshift_cuts.pdf"
