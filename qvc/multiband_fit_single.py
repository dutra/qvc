...
def main():
    ...
    # Choose Model class
    if args.lmc >= 0:
        print(f"\033[93m[INFO] Using LMC model (Q={args.lmc}).\033[0m")
        ModelClass = MyMultiVarModel_BLR_LMC
    elif args.lmc == -2:
        ModelClass = MyMultiVarModel_TauScale
    elif args.lmc == -3:
        ModelClass = MyMultiVarModel_S
    elif args.lmc == -4:
        ModelClass = MyMultiVarModel_SMAG
    elif args.lmc == -5:
        ModelClass = MyMultiVarModel_SMAG_MultiExp
    elif args.lmc == -6:
        ModelClass = MyMultiVarModel_SMAG_New
    else:
        ModelClass = OldModel  # fallback if needed
