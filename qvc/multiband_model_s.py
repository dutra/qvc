...
class ContiBLRQS(qs.Wrapper):
    ...
    def __init__(self, amp_cont, amp_blr, lag_blr, lag_disk, tau_drw, bwb_alpha, bwb_beta, s, width_cont, width_blr) -> None:
    ...
    def conv_observation_model(self, t: JAXArray, lag: JAXArray, width: JAXArray, s: float) -> JAXArray:
        """
        ...
        def tap(u, g):
            ...
            Phi = self.kernel.transition_matrix(0.0, s * (lag + u))
    ...
    def observation_model(self, X: JAXArray) -> JAXArray:
        ...
        h_cont0 = self.conv_observation_model(t, self.lag_disk[b], self.width_cont[b], self.s[b])
        # BLR lags behind continuum by lag_blr[b]  => total shift is lag_disk + lag_blr
        h_blr0  = self.conv_observation_model(t, self.lag_disk[b] + self.lag_blr[b], self.width_blr[b], self.s[b])
...
class MyMultiVarModel_S(MultiVarModel):
    ...
    def _build_gp(self, params):
        ...
        means = partial(MyMultiVarModel_S.mean_func, self.zero_mean, log_sigma_band.shape[0],
